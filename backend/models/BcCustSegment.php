...
/**
 * This is the model class for table "bc_cust_segment".
 *
 * @property int $id
 * @property int $biz_canvas_id
 * @property string $description
 */
class BcCustSegment extends \yii\db\ActiveRecord
{
    public $bc_label = 'Customers Segments';
    public $bc_key = 'cust-segment';
    /**
     * {@inheritdoc}
     */
    public static function tableName()
    {
        return 'bc_cust_segment';
    }
