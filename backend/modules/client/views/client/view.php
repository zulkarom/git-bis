        ...
        'attributes' => [
            [
                ...
                'value' => function ($model) {
                    return '<img src="' . Url::to([
                        '/client/client/profile-image',
                        'id' => $model->user_id
                    ]) . '" width="90" height="90">';
                }
            ],
        ...
        <div class="card-body">
                    ...
                    if ($clientExpert) {
                        foreach ($clientExpert as $clientEx) {
                            echo '<tr>
                                    ...
                                    <td><a href="' . Url::to([
                                '/client/client/assign-delete',
                                'id' => $clientEx->id,
                                'cid' => $model->id
                            ]) . '" data-confirm="Are you sure to remove this expert from this client?"><span class="fa fa-trash fa-xs"></span></a></td>
            ...
            <br/>
                ...
                <p>
                    ...
                    echo Html::button('Assign', [
                        'value' => Url::to([
                            '/client/client/assign',
                            'cid' => $model->id
                        ]),
