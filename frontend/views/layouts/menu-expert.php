...
<div class="nk-apps-sidebar is-dark">
            <div class="nk-apps-brand">
                <a href="<?=Url::to(['/expert/dashboard/index'])?>" class="logo-link">
                    <img class="logo-light logo-img" src="<?= $dirAssests?>/logo/mini-logo<?=Yii::$app->params['extension']?>.png" srcset="<?= $dirAssests?>/logo/logo-small2x<?=Yii::$app->params['extension']?>.png 2x" alt="logo">
                    <img class="logo-dark logo-img" src="<?= $dirAssests?>/logo/logo-dark-small<?=Yii::$app->params['extension']?>.png" srcset="<?= $dirAssests?>/logo/logo-dark-small2x<?=Yii::$app->params['extension']?>.png 2x" alt="logo-dark">
                </a>
            </div>
                    ...
                    <div class="nk-sidebar-content" data-simplebar>
                        <div class="nk-sidebar-menu">
                            ...
                            <ul class="nk-menu apps-menu">
                                ...
                                <li class="nk-menu-item">
                                    <a href="<?=Url::to(['/expert/chat'])?>" class="nk-menu-link" title="Consultation">
