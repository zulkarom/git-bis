            ...
            <div class="chat-leftsidebar">
                ...
                <div class="tab-content">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 overflow-hidden">
                                                ...
                                                <p class="text-muted font-size-13 mb-0">How to create a good marketing plan</p>
                                            </div>
                    ...
                    <div class="tab-pane" id="pills-setting" role="tabpanel" aria-labelledby="pills-setting-tab">
                        ...
                        <div>
                            <div class="user-profile-img">
                                <img src="<?=$web?>/chat/images/small/img-4.jpg" class="profile-img profile-foreground-img" style="height: 160px;" alt="">
                                <div class="overlay-content">
                                    <div>
                            ...
                            <div class="text-center p-3 p-lg-4 border-bottom pt-2 pt-lg-2 mt-n5 position-relative">
                                <div class="mb-3 profile-user">
                                    <img src="<?=$web?>/chat/images/users/avatar-1.jpg" class="rounded-circle avatar-lg img-thumbnail user-profile-image" alt="user-profile-image">
...
<script src="<?=$web?>/chat/libs/fg-emoji-picker/fgEmojiPicker.js"></script>
        ...
        <!-- page init -->
        <script src="<?=$web?>/chat/js/pages/index.init.js"></script>
