            ...
            <div class="nk-block-head">
                ...
                <?php $form = ActiveForm::begin(); ?>
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <?= $form
                                    ...
                                    ->label(false)
                                    ->textInput(['placeholder' => 'Enter your name', 'class' => 'form-control form-control-lg']) 
                                 ?>
                        ...
                        <div class="form-group">
                            <label class="form-label" for="password">Repeat Passcode</label>
                            <div class="form-control-wrap">
                                <a tabindex="-1" href="#" class="form-icon form-icon-right passcode-switch lg" data-target="password">
                                    <em class="passcode-icon icon-show icon ni ni-eye"></em>
                                    <em class="passcode-icon icon-hide icon ni ni-eye-off"></em>
                                ...
                                <?= $form
                                    ...
                                    ->label(false)
                                    ->passwordInput(['placeholder' => 'Repeat your passcode', 'class' => 'form-control form-control-lg'])
                                ?>
                            </div>
                        </div><!-- .form-group -->
                <div class="form-group">
